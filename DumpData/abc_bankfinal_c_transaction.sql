...
CREATE TABLE `c_transaction` (
  ...
  CONSTRAINT `account_no` FOREIGN KEY (`account_no`) REFERENCES `customer` (`account_no`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `c_transaction` WRITE;
/*!40000 ALTER TABLE `c_transaction` DISABLE KEYS */;
INSERT INTO `c_transaction` VALUES (111,'10-10-2019',500,0,123456),(112,'12-10-2019',500,0,123456);
/*!40000 ALTER TABLE `c_transaction` ENABLE KEYS */;
UNLOCK TABLES;
